...
import com.nlpsample.model.EntityInfo;
import com.nlpsample.model.SentimentInfo;
import com.nlpsample.model.TokenInfo;
...
public class ApiFragment extends Fragment {
    ...
    private void deliverResponse(GenericJson response) {
        ...
        if (response instanceof AnalyzeEntitiesResponse) {
            ...
            final com.nlpsample.model.TokenInfo[] array = new com.nlpsample.model.TokenInfo[size];
            for (int i = 0; i < size; i++) {
                array[i] = new com.nlpsample.model.TokenInfo(tokens.get(i));
            }
            activity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
